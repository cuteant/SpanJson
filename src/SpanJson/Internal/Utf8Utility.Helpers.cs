    ...
    internal static partial class Utf8Utility
    {
        ...
        internal static bool UInt32FirstByteIsAscii(uint value)
        {
            ...
            return (BitConverter.IsLittleEndian && (0u >= (value & 0x80u)))
                || (!BitConverter.IsLittleEndian && (JsonSharedConstant.TooBigOrNegative >= value)); // (int)value >= 0
        }
        ...
        internal static bool UInt32FourthByteIsAscii(uint value)
        {
            ...
            return (BitConverter.IsLittleEndian && (JsonSharedConstant.TooBigOrNegative >= value)) // (int)value >= 0
